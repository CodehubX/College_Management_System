...
## Welcome to https://codiumclub.github.io/CollegeManagementSystem/
...
This is a small College ERP system demo android application. It is the first demo version of this app. By modifying this, one can build basic ERP projects, such as Employee Management System etc.
	...
	>For Web Application of this go to https://github.com/codiumclub/CollegeManagementSystemWebApp/
...
#### Structure of project (Functional Requirements)
	...
	7. Placement (Only having placement access)
		...
		//Can check list of students, who can help tech placement related activities
	8. HOD
		8.1 Student List
...
### NOTE
 *_Developed with Love By codiumclub_*