package tech.codiumclub.collegeManagementSystem;
...
import tech.codiumclub.collegeManagementSystem.admin.AdminActivity;
import tech.codiumclub.collegeManagementSystem.app.config.AppController;
...
import tech.codiumclub.collegeManagementSystem.hod.HodActivity;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            if (session.getUserRole().equals("Admin")) {
                // User is already logged tech. Take him to Admin activity
                Intent intent = new Intent(this, AdminActivity.class);
                startActivity(intent);
                finish();
            } else if (session.getUserRole().equals("HOD")) {
                // User is already logged tech. Take him to HOD activity
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
            // Signed tech successfully, show authenticated UI.
    ...
    /**
     * function to verify login details tech mysql db
     */
    ...
    private void checkLogin(final String personName, final String email, final String personPhotoUrl) {
        ...
        pDialog.setMessage("Logging tech ...");
        showDialog();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        // Error tech login. Get the error message
